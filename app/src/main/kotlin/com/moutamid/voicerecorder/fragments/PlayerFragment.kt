...
import com.moutamid.voicerecorder.adapters.RecordingsAdapter
import com.moutamid.voicerecorder.extensions.config
import com.moutamid.voicerecorder.helpers.getAudioFileContentUri
import com.moutamid.voicerecorder.interfaces.RefreshRecordingsListener
...
class PlayerFragment(context: Context, attributeSet: AttributeSet) : MyViewPagerFragment(context, attributeSet), RefreshRecordingsListener {
    ...
    private fun setupColors() {
        ...
        context.updateTextColors(player_holder as ViewGroup)
